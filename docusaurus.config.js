...
const config = {
  ...
  organizationName: 'fatih.simsek52', // Usually your GitHub org/user name.
  projectName: 'Changelog', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {href: 'https://www.fatih-sim.com/disclaimer', label: 'DISCLAIMER', position: 'left'},
          {
